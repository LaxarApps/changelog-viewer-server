...
'../cached_fetch');var _cached_fetch2 = _interopRequireDefault(_cached_fetch);var _xml2js = require(
'xml2js');var _child_process = require(
'child_process');exports['default'] = 


function (_ref) {var serverUrl = _ref.serverUrl;var repositoriesRoot = _ref.repositoriesRoot;
   ...
   (0, _cached_fetch2['default'])(0);var getText = _cachedFetch.getText;var clearCache = _cachedFetch.clearCache;
   var api = { 
      ...
      var proto = { 
         getReleases: function getReleases() {
            ...
            then(function (tree) {
               ...
               var tds = table && table.tr && table.tr.map(function (tr) {return tr.td && tr.td[1] && tr.td[1];});
               var as = tds && tds.map(function (td) {return td.a && td.a[0] && td.a[0];});
            ...
            then(function (tags) {
               var versionData = tags.reduce(function (acc, tag) {
                  ...
                  if (match) {var _match = _slicedToArray(
                     ...
                     acc[versionTag].versions.push('refs/tags/' + _name);}
