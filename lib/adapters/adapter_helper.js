...
getMostRecentVersionFromReleases = getMostRecentVersionFromReleases; /**
                                                                      ...
                                                                      */var VERSION_MATCHER = exports.VERSION_MATCHER = /^v(\d+)\.(\d+)\.(\d+)$/;function getMostRecentVersionFromReleases(releases) {var versionObject = releases.reduce(function (mostRecentVersion, _ref) {var versions = _ref.versions;return versions.reduce(function (mostRecentVersion, versionString) {var _VERSION_MATCHER$exec = VERSION_MATCHER.exec(versionString);var _VERSION_MATCHER$exec2 = _slicedToArray(_VERSION_MATCHER$exec, 4);var name = _VERSION_MATCHER$exec2[0];var major = _VERSION_MATCHER$exec2[1];var minor = _VERSION_MATCHER$exec2[2];var patch = _VERSION_MATCHER$exec2[3];
