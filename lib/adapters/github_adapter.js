'use strict';var _slicedToArray = function () {function sliceIterator(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"]) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}return function (arr, i) {if (Array.isArray(arr)) {return arr;} else if (Symbol.iterator in Object(arr)) {return sliceIterator(arr, i);} else {throw new TypeError("Invalid attempt to destructure non-iterable instance");}};}(); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       */Object.defineProperty(exports, "__esModule", { value: true });var _es6Promise = require('es6-promise');var _cached_fetch = require('../cached_fetch');var _cached_fetch2 = _interopRequireDefault(_cached_fetch);var _repository_resource_fetcher = require('../repository_resource_fetcher');var _repository_resource_fetcher2 = _interopRequireDefault(_repository_resource_fetcher);var _adapter_helper = require('./adapter_helper');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default = 
...
function (logger, _ref, _ref2) {var category = _ref.category;var organization = _ref.organization;var oauthToken = _ref.oauthToken;var resourceCachePath = _ref2.resourceCachePath;
   ...
   function createRepository(repositoryData) {
      ...
      var get = function get(url) {return resourceFetcher.fetch(normalizedData, url, headers);};
