 ...
 */'use strict';Object.defineProperty(exports, '__esModule', { value: true });var _slicedToArray = (function () {function sliceIterator(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i['return']) _i['return']();} finally {if (_d) throw _e;}}return _arr;}return function (arr, i) {if (Array.isArray(arr)) {return arr;} else if (Symbol.iterator in Object(arr)) {return sliceIterator(arr, i);} else {throw new TypeError('Invalid attempt to destructure non-iterable instance');}};})();function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj };}var _es6Promise = require(
'es6-promise');var _cached_fetch = require(
'../cached_fetch');var _cached_fetch2 = _interopRequireDefault(_cached_fetch);exports['default'] = 
...
function (_ref) {var category = _ref.category;var organization = _ref.organization;var oauthToken = _ref.oauthToken;
   ...
   var VERSION_MATCHER = /^v(\d+)\.(\d+)\.(\d+)$/;var _cachedFetch = 
   ...
   function getRepositories() {
      ...
      then(function (repositories) {return repositories.map(createRepository);});}
            ...
            then(function (versions) {
               var versionData = versions.reduce(function (acc, version) {
                  ...
                  if (match) {var _match = _slicedToArray(
                     match, 4);var _name = _match[0];var major = _match[1];var minor = _match[2];var patch = _match[3];
                     ...
                     acc[versionTag].versions.push(_name);}
   ...
   return api;};module.exports = exports['default'];
