 ...
 */'use strict';Object.defineProperty(exports, '__esModule', { value: true });function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { 'default': obj };}var _es6Promise = require(
'es6-promise');var _nodeFetch = require(
'node-fetch');var _nodeFetch2 = _interopRequireDefault(_nodeFetch);
...
function () {var maxAgeMs = arguments.length <= 0 || arguments[0] === undefined ? TWO_HOURS : arguments[0];
   ...
   var stillValid = function stillValid(_ref) {var timestamp = _ref.timestamp;return timestamp > now() - maxAgeMs;};
